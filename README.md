### Hexlet tests, linter status, SonarQube, GitHub_Actions: Sonar.jml:
...
[![Coverage](https://sonarcloud.io/api/project_badges/measure?project=Met-s_java-project-71&metric=coverage)](https://sonarcloud.io/summary/new_code?id=Met-s_java-project-71)
[![Sonar](https://github.com/Met-s/java-project-71/actions/workflows/sonar-build.yml/badge.svg)](https://github.com/Met-s/java-project-71/actions/workflows/sonar-build.yml)
